...
The per-gene relative abundances (iPM) are available in SI file \texttt{syn1\_omics.xlsx}.
...
\end{equation}
The resulting per-gene absolute copy numbers are available in SI file \texttt{syn1\_omics.xlsx}.
...
The per-protein localization assignments are available in SI file \texttt{syn1\_omics.xlsx}.
