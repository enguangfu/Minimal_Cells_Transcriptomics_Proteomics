\subsubsection{PacBio RNA Sample Preparation}
...
\subsubsection{PacBio RNA Sample Quality Control Analysis}\label{sec:methods-pacbio-qc}
RNA-sample QC was conducted in the same manner as in Illumina, and the resulting cDNA and final libraries were additionally sized on an Agilent Femto Pulse.
...
\label{method:pacbio-clustering}
