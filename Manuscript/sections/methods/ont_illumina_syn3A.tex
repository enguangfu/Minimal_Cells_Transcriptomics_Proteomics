...
Resulting SAM output was converted, sorted, and indexed using \texttt{samtools} v1.x~\cite{li2009samtools}.
...
Reads were aligned to the JCVI-syn3A reference (NCBI accession CP016816.2) with \texttt{bowtie2} v2.5~\cite{langmead2012bowtie2} in default paired-end mode.
...
SAM output was converted, sorted, and indexed with \texttt{samtools} v1.22~\cite{li2009samtools}.
