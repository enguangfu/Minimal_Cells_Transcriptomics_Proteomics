\subsection{Minimization reallocates mRNA pool toward translation at the expense of central metabolism}
...
\begin{figure}[H]
    ...
    (a) Composition of the messenger-RNA pool by Secondary function in \syn~and \syna, quantified by Illumina.
    ...
    (c) mRNA and protein fold changes of RNA polymerase, the degradosome, and the central-carbon enzymes. mRNA TPM quantified by Illumina.
    (d) The 21-gene $\sim$11~kb ribosomal-protein operon (\gene{rpsJ}{0672}$\rightarrow$\gene{secY}{0652}, minus strand) and its upstream neighbourhood in \syn~and \syna, aligned on the shared operon 5$'$ end (transcription start; gene tracks with Illumina depth, $\times$ genome-mean). Illumina of \syn~and \syna~\cite{sandberg_adaptive_2023} used.}
