...
The transferred half-lives were shorter than in \syn~(median 5.7~h versus 32~h, tracking \syna's higher protease concentration) yet still exceeded the 105-min \syna~doubling time for all but 6.5\% of proteins (Fig.~\ref{fig:si-correlation}j), so protein turnover remains dominated by dilution through growth.
...
\begin{sifigure}
    \centering
    \includegraphics[width=1\linewidth]{figures/si-correlation.pdf}
